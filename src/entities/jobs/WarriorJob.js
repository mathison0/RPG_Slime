...
export default class WarriorJob extends BaseJob {
    ...
    useThrust() {
        ...
        // 디버깅: skillInfo.range 값 확인
        console.log('찌르기 스킬 정보:', skillInfo);
        console.log('찌르기 range 값:', skillInfo.range);
        ...
        const width = skillInfo.width || 40; // JobClasses에서 가져온 width 값 사용
        const height = skillInfo.range;
        
        // 디버깅: 실제 사용되는 height 값 확인
        console.log('찌르기 이펙트 height 값:', height);
